	...
	render() {
		return (
			<div className="Banner">
				...
				<div className="Banner__Title">Hi, I'm Lysandre</div>
				<div className="Banner__Subtitle">
					NLP Machine Learning Enginner @
					<a style={{ cursor: "pointer", whiteSpace: "nowrap" }} onClick={() => window.open("http://www.huggingface.co")}>
						Hugging Face
					</a>
					<br />
					Part-time full stack web developer
				</div>
	...
	render() {
		return (
			<div id={"icon" + this.props.index} className="Banner__Icon">
				...
				{this.state.hover ? (
					<span className="Banner__IconText">{this.props.text}</span>
				) : (
